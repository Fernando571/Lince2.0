error id: file://<WORKSPACE>/src/main/scala/lince/backend/SmallStep.scala:lince/syntax/Lince.Action.StrmDef.
file://<WORKSPACE>/src/main/scala/lince/backend/SmallStep.scala
empty definition using pc, found symbol in pc: lince/syntax/Lince.Action.StrmDef.
empty definition using semanticdb

found definition using fallback; symbol StrmDef
offset: 3103
    ...
    st.p match {
      ...
      case StrAssign(n, s) =>
        ...
        st.s.get(n) match
          ...
          case _ => Some(Action.StrmDe@@f(n,s) -> st.copy(p=Skip,s=st.s+(n->s)))
